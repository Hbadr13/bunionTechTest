...
const SlawDecrease = ({ width, height, color, ...props }: { width: number | string, height: number | string, color: string }) => (
    <Svg viewBox="0 0 24 24" width={width} height={height} color="#eab308" fill="none" {...props}>
